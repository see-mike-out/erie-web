(function(g,f){typeof exports==='object'&&typeof module!=='undefined'?f(exports,require('d3'),require('arquero'),require('vega-statistics')):typeof define==='function'&&define.amd?define(['exports','d3','arquero','vega-statistics'],f):(g=typeof globalThis!=='undefined'?globalThis:g||self,f(g.Erie={},g.d3,g.arquero,g.vegaStatistics));})(this,(function(exports,d3,arquero,vegaStatistics){'use strict';function deepcopy$1(o) {
...
// ramping
const RampMethods = [true, false, 'abrupt', 'linear', 'exponential'];function isJSON(d) {
  try {
    JSON.parse(d);
    return true;
  } catch {
...
const ForceRepeatScale = 'forceRepeatScale',
  ...
  AfterAll = 'afterAll',
  AfterThis = 'afterThis';const OverStrm = 'OverlayStream', UnitStrm = 'UnitStream';
